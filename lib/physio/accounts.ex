defmodule Physio.Accounts do
  ...
  """
  def get_user!(id), do: User |> preload(:user_profile) |> Repo.get!(id)
  ...
  def list_doctor() do
    Doctor
    |> preload([:doctor_profile, :appointment])
  ...
  def list_users() do
    User
    |> preload([:user_profile, :appointment])
  ...
  alias Physio.Accounts.{Admin, AdminToken, AdminNotifier}

defmodule PhysioWeb.ConnCase do
  @moduledoc """
  ...
  by setting `use PhysioWeb.ConnCase, async: true`, although
  ...
  using do
    quote do
      ...
      import PhysioWeb.ConnCase

      alias PhysioWeb.Router.Helpers, as: Routes

      # The default endpoint for testing
      @endpoint PhysioWeb.Endpoint
    end
  end

  setup tags do
    Physio.DataCase.setup_sandbox(tags)
  ...
  def register_and_log_in_user(%{conn: conn}) do
    user = Physio.AccountsFixtures.user_fixture()
  ...
  def log_in_user(conn, user) do
    token = Physio.Accounts.generate_user_session_token(user)
  ...
  def register_and_log_in_doctor(%{conn: conn}) do
    doctor = Physio.AccountsFixtures.doctor_fixture()
  ...
  def log_in_doctor(conn, doctor) do
    token = Physio.Accounts.generate_doctor_session_token(doctor)
